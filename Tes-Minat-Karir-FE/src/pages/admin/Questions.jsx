        ...
        <div className="grid grid-cols-3 gap-4 mb-6">
          ...
          {[
            ...
            >
              ...
              <span className={`text-xs px-2 py-1 rounded-full ${card.color === "green"
              ...
              <tr>
                ...
                <th className="p-4 text-left">
                  <div className="flex items-center gap-1">
                    ...
                    <span
                      title="Certainty Factor (CF) adalah nilai kepastian pakar dengan rentang 0 sampai 1."
                    ...
                    <tr key={q.id} className="border-t hover:bg-gray-50">
                      ...
                      <td className="p-4">
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() => openEdit(q)}
                            className="text-xs px-3 py-1 rounded-full bg-amber-100 text-amber-700 hover:bg-amber-700 hover:text-white transition-all"
                          >
                            Edit
                          </button>
                          <button
                            onClick={() => openDelete(q)}
                            className="text-xs px-3 py-1 bg-red-100 text-red-600 hover:bg-red-500 hover:text-white transition-all duration-200 rounded-full"
                          >
                            Hapus
                          </button>
                        </div>
        ...
        >
          <div className="space-y-3">
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className="w-full bg-amber-700 hover:bg-amber-800 text-white py-2 rounded-lg text-sm disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
