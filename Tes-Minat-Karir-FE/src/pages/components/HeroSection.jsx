...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-6 overflow-hidden pt-28 md:pt-32 pb-16 md:pb-20"
    >
      ...
      <div className="relative z-10 w-full max-w-5xl flex flex-col items-center">
        {/* Top Update Badge */}
        <div className="flex items-center gap-2 md:gap-4 bg-white/60 backdrop-blur-xl border border-white/70 shadow-[0_4px_24px_rgba(0,0,0,0.08)] rounded-full p-1 md:p-1.5 pr-4 md:pr-6 cursor-pointer hover:bg-white/80 hover:scale-[1.03] transition-all duration-300 mb-8 md:mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700 fill-mode-both delay-300">
        ...
        {/* Headline */}
        <h1 className="hero-title text-[2.5rem] leading-[1.1] sm:text-5xl md:text-6xl lg:text-[5.5rem] font-extrabold tracking-tight md:leading-[0.95] text-black w-full mb-6 md:mb-8 whitespace-pre-line">
          {headline}
        </h1>
